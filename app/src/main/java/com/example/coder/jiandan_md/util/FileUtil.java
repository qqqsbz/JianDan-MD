...
public class FileUtil {
     ...
     * @param picUrl
     */
    public static void savePicture(Activity activity, String picUrl, DownLoadFinishCallBack downLoadFinishCallBack) {
        ...
        if (FileUtil.copyTo(cacheFile, newFile)) {
            ...
            downLoadFinishCallBack.onLoadingComplete(bundle);

        } else {

            Toast.makeText(activity,ConstantString.DOWNLOAD_FAIL,Toast.LENGTH_LONG).show();
        }
